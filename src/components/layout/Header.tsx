...
},
{
  ...
  { label: "Analysis", href: "/services#analysis" },
...
}: {items: DropdownItem[];isOpen: boolean;onClose: () => void;onNavClick: (e: React.MouseEvent, href: string) => void;}) {
  return (
    <AnimatePresence>
      {isOpen &&
      <motion.div
...
}: {item: NavItem;isActive: boolean;onNavClick: (e: React.MouseEvent, href: string) => void;}) {
