      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-0.5 bg-white/20 z-0" />
            <motion.div 
              className="absolute left-0 top-1/2 -translate-y-1/2 h-0.5 bg-gold z-0"
              initial={{ width: "0%" }}
                    ...
                    {isTop ? (
                      <>
                        ...
                        <div className="flex justify-center">
                          <div className={`w-4 h-4 rounded-full ${event.dotColor} ring-4 ring-slate-800 z-10`} />
                        </div>
                        {/* Spacer for bottom */}
                      ...
                      <>
                        ...
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5 mt-8">
                          <div className="flex items-center gap-2 mb-3">
                            <div className={`w-8 h-8 rounded-full bg-white/10 flex items-center justify-center`}>
                              <IconComponent className={`w-4 h-4 ${event.iconColor}`} />
                            </div>
        ...
        >
          ...
          <motion.div 
            className="absolute left-6 top-0 w-0.5 bg-gold origin-top"
            initial={{ scaleY: 0 }}
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-6 top-6 -translate-x-1/2 z-10">
                    <div className={`w-4 h-4 rounded-full ${event.dotColor} ring-4 ring-slate-800`} />
                  </div>
