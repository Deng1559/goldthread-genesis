      ...
      <main className="flex-1 container-wide section-padding">
        <article className="max-w-4xl mx-auto py-12">
          ...
          <section className="space-y-6 text-charcoal text-sm leading-relaxed">
            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">1. Introduction</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">2. Information We Collect</h2>

              <h3 className="text-base font-medium text-charcoal/90 mt-4 mb-2">A. Information You Voluntarily Provide</h3>
              ...
              <h3 className="text-base font-medium text-charcoal/90 mt-4 mb-2">B. Automatically Collected Information</h3>
              ...
              <h3 className="text-base font-medium text-charcoal/90 mt-4 mb-2">C. Investor Due Diligence Data</h3>
            ...
            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">3. How We Use Your Information</h2>
              ...
              <p className="mt-2 font-medium text-charcoal">We do not sell your personal information.</p>
            </div>

            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">4. Cookies & Tracking Technologies</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">5. Information Sharing</h2>
              <p>We may share information only under the following circumstances:</p>

              <h3 className="text-base font-medium text-charcoal/90 mt-3 mb-2">A. Service Providers</h3>
              ...
              <h3 className="text-base font-medium text-charcoal/90 mt-3 mb-2">B. Regulatory or Legal Requirements</h3>
              <p>If required to comply with laws or court orders, protect legal rights, or respond to regulatory inquiries.</p>

              <h3 className="text-base font-medium text-charcoal/90 mt-3 mb-2">C. Business Transactions</h3>
            ...
            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">6. Data Security</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">7. Data Retention</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">8. Your Rights</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">9. International Visitors</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">10. Investor Disclaimer</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">11. Third-Party Links</h2>
              <p>Our website may contain links to third-party websites. We are not responsible for their privacy practices.</p>
            </div>

            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">12. Updates to This Policy</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-charcoal mb-2">13. Contact Information</h2>
