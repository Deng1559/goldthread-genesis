...
import { Download, Linkedin, Mail, Award, FileCheck, Wrench, Quote } from "lucide-react";
import jayLesserImg from "@/assets/jay-lesser.jpg";
        ...
        <div className="container-narrow px-4 md:px-6">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            ...
            <motion.div
              ...
              <div className="aspect-[3/4] border-2 border-gold/30 rounded-lg overflow-hidden">
                <img src={jayLesserImg} alt="Harold 'Jay' Lesser" className="w-full h-full object-cover" />
              </div>
            </motion.div>
        ...
        <div className="container-narrow px-4 md:px-6">
          <motion.div
            ...
            <motion.div variants={fadeUp} className="prose prose-lg max-w-none">
              <p className="text-base md:text-lg text-foreground/80 leading-relaxed mb-6">Harold (Jay) Lesser is a highly knowledgeable professional with over three decades of

experience in the geotechnical construction and mining industry. He excels in

conducting field investigations and contributing to the development of large-scale

projects. Mr. Lesser’s expertise encompasses geotechnical construction, limited access

repair, restoration, pressure grouting, and particle size analysis. He has worked on a
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12">
              ...
              <motion.div variants={fadeUp}>
                ...
                <ul className="space-y-3 md:space-y-4">
                  {TECHNICAL_ACHIEVEMENTS.map((achievement, index) => <li key={index} className="flex gap-3">
