      ...
      <main className="flex-1 container-wide section-padding">
        <article className="prose prose-invert max-w-4xl mx-auto py-12">
          ...
          <section className="space-y-6 text-white/80 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-2">2. About MineTeck</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-2">3. No Offer or Solicitation</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-2">4. Forward-Looking Statements</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-2">5. Eligibility</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-2">7. Confidential Information</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-2">8. Website Use Restrictions</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-white mb-2">9. Third-Party Links</h2>
